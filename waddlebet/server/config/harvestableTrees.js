...
/** Denser grid + staggered offset pass for more tree coverage. */
export const TREE_GRID_STEP = 16;
/** Stay clear of mountain boundary walls. */
...
/** Circles to keep harvestable trees off props (local zone coords). */
