export default {
    ...
    'guest.signIn': {
        en: 'Sign in with Phantom or MetaMask',
        zh: '使用 Phantom 或 MetaMask 登录',
        es: 'Iniciar sesión con Phantom o MetaMask',
        pt: 'Entrar com Phantom ou MetaMask',
        ko: 'Phantom 또는 MetaMask로 로그인',
        ja: 'PhantomまたはMetaMaskでサインイン',
        fr: 'Se connecter avec Phantom ou MetaMask',
        de: 'Mit Phantom oder MetaMask anmelden',
        ru: 'Войти через Phantom или MetaMask',
        ar: 'تسجيل الدخول باستخدام Phantom أو MetaMask',
    },
    'guest.signInOr': {
        en: 'or',
        zh: '或',
