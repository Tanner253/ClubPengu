/**
 * PlayerPreview3D - Renders a 3D rotating character preview
 * Used in ProfileMenu and PlayerCreatorOverlay for consistent character previews
 * Supports all character types: penguins, dogs, frogs, whales, marcus
 */
...
// Color palette for character skins (primarily for penguin characters)
const SKIN_COLORS = {
...
export default PlayerPreview3D;
