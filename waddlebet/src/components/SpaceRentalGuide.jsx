/**
 * SpaceRentalGuide - Informational guide about space rental mechanics
...
const SpaceRentalGuide = ({ 
    ...
    const rentInfo = [
        ...
        { label: 'Total Spaces', value: '10 available', color: 'text-green-400', icon: '🏠' },
    ];
                ...
                <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-6">
                    ...
                    <div className="bg-gradient-to-r from-cyan-500/20 via-purple-500/20 to-cyan-500/20 rounded-lg p-4 border border-cyan-500/30 text-center">
                        <p className="text-cyan-400 font-semibold">
                            🎉 Rent an space to advertise & earn from visitors! 🎉
                        </p>
                    </div>
                </div>
...
export default SpaceRentalGuide;
