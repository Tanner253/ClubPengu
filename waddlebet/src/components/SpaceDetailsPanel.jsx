/**
 * SpaceDetailsPanel - Marketing panel for spaces available for rent
...
const SpaceDetailsPanel = ({ 
    ...
    const spaceName = spaceData?.spaceId?.replace('space', 'Space ') || 'This Space';
    
    // Benefits of owning an space
    const benefits = [
        {
            icon: '📺',
        ...
        },
        {
            ...
            description: 'Track visits and engagement. See who\'s visiting and how your space is performing.'
        }
    ];
                ...
                <div className="relative px-6 py-6 bg-gradient-to-r from-emerald-600/30 via-cyan-600/20 to-purple-600/30 border-b border-white/10">
                    ...
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
                        <div className="bg-gradient-to-r from-yellow-500 to-amber-500 text-black px-4 py-1.5 rounded-full font-bold text-sm shadow-lg shadow-yellow-500/30">
                            💎 {SPACE_CONFIG.DAILY_RENT_CPW3?.toLocaleString() || '10,000'} $WADDLE/day
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto px-6 py-8">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-slate-400 text-sm">
                            Rent an space and unlock powerful features for your brand, community, or project.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="text-red-400 font-mono">
                                    {SPACE_CONFIG.GRACE_PERIOD_HOURS}h
                                </span>
                            </div>
                            <div className="flex justify-between">
