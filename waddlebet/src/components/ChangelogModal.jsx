...
const CHANGELOG = [
    {
        ...
        description: 'Critical fixes for Blackjack payouts, UNO spectator display, Monopoly rent scaling, player preview rendering, appearance synchronization, banner interactions, and personal space wardrobe',
        highlight: false,
        changes: [
            ...
            { type: 'fix', text: 'BannerZoomOverlay now works for all clickable banners: space instructions, casino charts, slot drop rates, nightclub banners, highway billboards' },
            { type: 'fix', text: 'BannerZoomOverlay improved with centered content, better formatting, and mobile portrait support' },
            { type: 'feature', text: 'Personal space wardrobe now has full penguin creator functionality - customize appearance in-game without disconnecting' },
            { type: 'feature', text: 'Personal space wardrobe loads all cosmetics from database instead of hardcoded values for better maintainability' },
            { type: 'feature', text: 'SpaceRentalGuide - new React component for space rental information with mobile portrait support' },
    ...
    },
    {
        ...
        changes: [
            ...
            { type: 'feature', text: 'Space banner customization: gradients, fonts, colors, alignment' },
            ...
            { type: 'fix', text: 'Space settings persist correctly with markModified for nested objects' },
    ...
    },
    {
        ...
        title: '🏠 Space Economy & X402 Payments',
        description: 'Full space rental system with Solana X402 payment protocol, automated rent collection, and comprehensive test coverage',
        highlight: true,
        stats: { filesChanged: 39, additions: 10943, deletions: 104 },
        changes: [
            { type: 'feature', text: 'Complete space ownership/rental system with SpaceContext state management' },
            { type: 'feature', text: 'SpaceEntryModal - visit and enter spaces with ownership display' },
            { type: 'feature', text: 'SpaceRentalModal - purchase/rent spaces with Solana payments' },
            { type: 'feature', text: 'SpaceSettingsPanel - customize your space (privacy, style, furniture)' },
            { type: 'feature', text: 'X402 Payment Protocol - HTTP 402-based micropayments via Solana' },
            { type: 'backend', text: 'SpaceService.js (442 lines) - server-side space business logic' },
            { type: 'backend', text: 'Space.js model (327 lines) - MongoDB schema for space ownership' },
            { type: 'backend', text: 'spaceHandlers.js (361 lines) - WebSocket handlers for real-time space events' },
            ...
            { type: 'improvement', text: 'SpaceOccupancySystem.js refactored for rental integration' },
    ...
    },
    {
        ...
        changes: [
            { type: 'backend', text: 'Complete MongoDB database integration with 8 new models (User, Match, Challenge, Transaction, Pet, PromoCode, AuthSession, PromoRedemption)' },
    ...
    },
    {
        ...
        changes: [
            ...
            { type: 'refactor', text: 'Extracted 20+ prop classes (Space, Campfire, Bench, PineTree, ChristmasTree, etc.)' },
    ...
    },
    {
        ...
        description: 'Nightclub with disco mode, spaces, bench seating, and economic systems',
        ...
        changes: [
            ...
            { type: 'feature', text: 'Space interiors with customizable furniture' },
    ...
    },
    {
        ...
        description: 'Real-time multiplayer with WebSocket sync, spaces, emotes',
        ...
        changes: [
            ...
            { type: 'feature', text: 'Space system with multiple themed interiors' },
            ...
            { type: 'backend', text: 'Room-based architecture for Town, Nightclub, Spaces' },
    ...
    },
    {
        ...
        changes: [
            ...
            { type: 'feature', text: 'VoxelPlayerDesigner.jsx - full character customization (474 lines)' },
            ...
            { type: 'feature', text: 'Pet companion system with 10 colors (Pet.js - 486 lines)' },
            { type: 'feature', text: 'Pet care: feed, play, rest with stat management' },
            ...
            { type: 'feature', text: 'TownCenter spawn area with spaces, trees, campfire (501 lines)' },
