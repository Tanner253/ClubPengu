/**
 * PlayerCreatorOverlay - In-game player customization overlay
 * 
 * Opens when player enters the Personal Space (Wardrobe).
 * Mirrors the full VoxelPlayerDesigner functionality.
...
// This matches VoxelPlayerDesigner - used as fallback when database hasn't loaded
...
function PlayerCreatorOverlay({ isOpen, onClose, currentData, onSave }) {
    ...
    // Unlocked items from user data - match VoxelPlayerDesigner structure
    ...
    useEffect(() => {
        ...
        // No cleanup needed - buildCharacter handles its own retries
...
export default PlayerCreatorOverlay;
