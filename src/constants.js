...
export const PALETTE = {
    ...
    teal: '#008080', lime: '#32CD32', cyan: '#00CED1', magenta: '#C71585',
    lavender: '#B8A9C9', coral: '#E57373', mint: '#7FBF7F', navy: '#001F3F',
    maroon: '#6B2C2C', olive: '#6B6B00', silver: '#A0A0A0', sky: '#6BB3D9',
