...
class TownCenter {
    ...
    /**
     * Check if player can land on an object at given position
     */
    ...
    /**
     * Update method for animations (campfire, etc.)
     * @param {number} time - Current time in seconds
     * @param {number} delta - Time since last frame
     */
    update(time, delta) {
        // Placeholder for future animations (campfire flames, etc.)
        // Currently handled directly in VoxelWorld
    }
