...
const en: Record<string, string> = {
  ...
  "pill.bscSoon": "BSC · Coming Soon",
  "hero.chains.title": "Built for Multichain",
  ...
  "hero.chains.bsc": "BNB Smart Chain",
  "hero.chains.bscStatus": "Coming Soon",
  "hero.chains.bscSub": "Binance EVM",
  ...
  "hero.token.chains": "Solana ($CP) + Robinhood Chain ($WADDLE) live — BNB Smart Chain expansion coming",
  "hero.scroll": "Scroll",
  ...
  "multichain.lead":
    "WaddleBet is expanding beyond a single chain. $WADDLE is live on Robinhood Chain today — and we're transparently exploring BNB Smart Chain (BSC) next to solidify our multichain architecture: same penguin world, separate rails per chain.",
  ...
  "multichain.why.b3": "Same penguin world, multiple chains — one community",
  "multichain.why.b4": "More tokens, more liquidity, more wagers",
  "multichain.why.b5": "Future-proof architecture — Solana, Robinhood EVM, and BSC on the roadmap",
  ...
  "multichain.bsc.badge": "Coming Soon",
  "multichain.bsc.title": "BNB Smart Chain · Binance EVM",
  "multichain.bsc.p1":
    "Binance Smart Chain is one of the largest EVM ecosystems in crypto — deep liquidity, a global user base, and a mature BEP-20 token standard. We're transparently exploring BSC as our next multichain expansion.",
  "multichain.bsc.p2":
    "No launch date yet. We're designing the same per-chain account model you know from Solana and Robinhood Chain: separate rails, no treasury bridges, same penguin world. Follow this whitepaper for updates.",
  "multichain.bsc.status": "◐ Exploring BSC expansion",
  ...
  "footer.chains": "Solana · Robinhood Chain · BSC (coming soon)",
...
const zhTW: Record<string, string> = {
  ...
  "pill.bscSoon": "BSC · 即將推出",
  "hero.chains.title": "多鏈建置",
  "hero.chains.solana": "Solana",
  ...
  "hero.cta.play": "立即遊玩",
  "hero.token.chains": "Solana（$CP）+ Robinhood Chain（$WADDLE）已上線 — BSC 擴展即將推出",
  "hero.scroll": "向下捲動",
  ...
  "multichain.lead":
    "WaddleBet 正超越單鏈。$WADDLE 已於 Robinhood Chain 上線——我們也正透明地探索 BNB Smart Chain（BSC），以鞏固多鏈架構：同一企鵝世界，每鏈獨立軌道。",
  ...
  "multichain.why.b3": "同一企鵝世界、多鏈並行——一個社群",
  "multichain.why.b4": "更多代幣、更多流動性、更多對賭",
  "multichain.why.b5": "面向未來的架構——Solana、Robinhood EVM 與 BSC 均在路線圖上",
  ...
  "multichain.bsc.badge": "即將推出",
  "multichain.bsc.title": "BNB Smart Chain · Binance EVM",
  "multichain.bsc.p1":
    "BNB Smart Chain 是加密領域最大的 EVM 生態之一——深度流動性、全球用戶基礎與成熟的 BEP-20 標準。我們正透明地探索 BSC 作為下一個多鏈擴展方向。",
  "multichain.bsc.p2":
    "尚無上線日期。我們將沿用 Solana 與 Robinhood Chain 相同的每鏈帳戶模型：獨立軌道、無金庫跨鏈橋、同一企鵝世界。請關注本白皮書更新。",
  "multichain.bsc.status": "◐ 探索 BSC 擴展中",
  ...
  "footer.builtOn": "建置於",
  "footer.chains": "Solana · Robinhood Chain · BSC（即將推出）",
  "footer.community": "社群",
