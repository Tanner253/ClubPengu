...
const en: Record<string, string> = {
  ...
  "hero.sub":
    "Live on Solana today — expanding to Robinhood Chain (Ethereum EVM). Connect your wallet, wager any token, and waddle into the first social metaverse built for multiple chains.",
  "pill.noKyc": "No KYC",
  ...
  "about.lead":
    "WaddleBet brings classic penguin social gaming into Web3 — live on Solana with instant SPL wagering, and expanding to Robinhood's Ethereum-compatible EVM chain to reach millions more players.",
...
const zhTW: Record<string, string> = {
  ...
  "hero.sub":
    "Solana 今日上線——正擴展至 Robinhood Chain（以太坊 EVM）。連接錢包、以任意代幣對賭，進入為多鏈打造的社交元宇宙。",
  ...
  "about.title.web3": "Web3",
  "about.lead":
    "WaddleBet 將經典企鵝社交遊戲帶入 Web3——Solana 上即時 SPL 對賭已上線，正擴展至 Robinhood 以太坊相容 EVM 鏈，觸及更多玩家。",
