...
const CHANGELOG_DATA: ChangelogVersion[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "feature", text: "$CPx402 Pebble deposits - buy pebbles with $CPx402 at 1.5x premium ratee" },
  ...
  },
  {
    ...
    title: "🚀 WaddleBet Rebrand & $CPx402 Token Launch",
    description: "Major rebranding to WaddleBet with $CPx402 token launch. Airdrop for OG holders who helped invest and get the game developed!",
    highlight: true,
    changes: [
      { type: "feature", text: "$CPx402 token launching on Solana - airdrop for early supporters and investors" },
  ...
  },
  {
    ...
    description: "Tiered status system based on $CPx402 holdings with particle effects",
    ...
    changes: [
      ...
      { type: "feature", text: "Real-time $CPx402 balance checking via Solana RPC" },
