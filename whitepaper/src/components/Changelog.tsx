...
const CHANGELOG_DATA: ChangelogVersion[] = [
  ...
  },
  {
    ...
    description: "Major rebranding to WaddleBet with $CP token launch. Airdrop for OG holders who helped invest and get the game developed!",
    highlight: true,
    changes: [
      { type: "feature", text: "$CP token launching on Solana - airdrop for early supporters and investors" },
