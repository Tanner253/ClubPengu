...
const CHANGELOG_DATA: ChangelogVersion[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "feature", text: "$BAGS Pebble deposits - buy pebbles with $BAGS at 1.5x premium rate" },
  ...
  },
  {
    ...
    title: "🚀 WaddleBet Rebrand & $BAGS Token Launch",
    description: "Major rebranding to WaddleBet with $BAGS token launch on Bags.fm. Fresh start after 700k ATH pump never supported us. Airdrop for OG holders who helped invest and get the game developed!",
    highlight: true,
    changes: [
      { type: "feature", text: "$BAGS token launching on Bags.fm - airdrop for early supporters and investors" },
  ...
  },
  {
    ...
    description: "Tiered status system based on $BAGS holdings with particle effects",
    ...
    changes: [
      ...
      { type: "feature", text: "Real-time $BAGS balance checking via Solana RPC" },
