...
const CHANGELOG_DATA: ChangelogVersion[] = [
  {
    ...
    title: "🦐 Shrimp Character & Feathers System",
    description: "New playable shrimp character, feathers currency system, PBR casino slot reels, security improvements, and QoL updates",
    highlight: true,
    ...
    changes: [
      ...
      { type: "feature", text: "Feathers currency system - earn feathers through gameplay activities" },
      { type: "feature", text: "PBR Slot Reels - realistic physically-based rendering for casino slots (PBRSlotReels.js - 699 lines)" },
      { type: "feature", text: "Spectator wager banner - shows active wagers during match spectating" },
      { type: "backend", text: "UserService feathers tracking and rewards" },
      { type: "backend", text: "Enhanced character registry with shrimp support" },
      { type: "security", text: "Ban hammer system - admin tools for moderation" },
      { type: "security", text: "Pebble exploit fix - prevents currency duplication" },
      { type: "security", text: "React Server Components CVE vulnerability patch" },
      { type: "fix", text: "Gold igloo state synchronization issue" },
      { type: "fix", text: "Gifting transaction processing improvements" },
      { type: "fix", text: "WagerTokenSelector UI improvements" },
      { type: "improvement", text: "Casino exterior and interior visual overhaul" },
      { type: "improvement", text: "Campfire particle effects and ambiance" },
      { type: "improvement", text: "Christmas tree decorations update" },
      { type: "improvement", text: "Town center layout refinements" },
      { type: "content", text: "Euphoria integration documentation" },
    ],
  },
  {
    version: "1.0.3",
